...
namespace Hardware::Registers::OCOTP {
    ...
    namespace CTRL {
        ...
        using ADDR = LowLevel::Field<Reg, 0, 5, std::uint32_t>; /**< Addr，5位读写字段。 */
        using BUSY = LowLevel::Field<Reg, 8, 1, std::uint32_t>; /**< Busy，1位读写字段。 */
        using ERROR = LowLevel::Field<Reg, 9, 1, std::uint32_t>; /**< Error，1位读写字段。 */
        using RD_BANK_OPEN = LowLevel::Field<Reg, 12, 1, std::uint32_t>; /**< Rd Bank Open，1位读写字段。 */
        using RELOAD_SHADOWS = LowLevel::Field<Reg, 13, 1, std::uint32_t>; /**< Reload Shadows，1位读写字段。 */
        /** @brief WR_UNLOCK 的取值。 */
        enum class WR_UNLOCK_Values : std::uint32_t {
            KEY = 0x3E77,
        };
        using WR_UNLOCK = LowLevel::Field<Reg, 16, 16, WR_UNLOCK_Values>; /**< Wr Unlock，16位读写字段。 */
    } // namespace CTRL
    ...
    namespace CUST0 {
        ...
        using BITS = LowLevel::Field<Reg, 0, 32, std::uint32_t>; /**< Bits，32位读写字段。 */
    } // namespace CUST0
    ...
    namespace LOCK {
        ...
        using CUST0 = LowLevel::Field<Reg, 0, 1, std::uint32_t>; /**< Cust0，1位读写字段。 */
        using CUST1 = LowLevel::Field<Reg, 1, 1, std::uint32_t>; /**< Cust1，1位读写字段。 */
        using CUST2 = LowLevel::Field<Reg, 2, 1, std::uint32_t>; /**< Cust2，1位读写字段。 */
        using CUST3 = LowLevel::Field<Reg, 3, 1, std::uint32_t>; /**< Cust3，1位读写字段。 */
        using CRYPTOKEY = LowLevel::Field<Reg, 4, 1, std::uint32_t>; /**< Cryptokey，1位读写字段。 */
        using CRYPTODCP = LowLevel::Field<Reg, 5, 1, std::uint32_t>; /**< Cryptodcp，1位读写字段。 */
        using HWSW_SHADOW = LowLevel::Field<Reg, 6, 1, std::uint32_t>; /**< Hwsw Shadow，1位读写字段。 */
        using CUSTCAP_SHADOW = LowLevel::Field<Reg, 7, 1, std::uint32_t>; /**< Custcap Shadow，1位读写字段。 */
        using HWSW = LowLevel::Field<Reg, 8, 1, std::uint32_t>; /**< Hwsw，1位读写字段。 */
        using CUSTCAP = LowLevel::Field<Reg, 9, 1, std::uint32_t>; /**< Custcap，1位读写字段。 */
        using ROM_SHADOW = LowLevel::Field<Reg, 10, 1, std::uint32_t>; /**< Rom Shadow，1位读写字段。 */
        using UNALLOCATED = LowLevel::Field<Reg, 11, 5, std::uint32_t>; /**< Unallocated，5位读写字段。 */
        using UN0 = LowLevel::Field<Reg, 16, 1, std::uint32_t>; /**< Un0，1位读写字段。 */
        using UN1 = LowLevel::Field<Reg, 17, 1, std::uint32_t>; /**< Un1，1位读写字段。 */
        using UN2 = LowLevel::Field<Reg, 18, 1, std::uint32_t>; /**< Un2，1位读写字段。 */
        using OPS = LowLevel::Field<Reg, 19, 1, std::uint32_t>; /**< Ops，1位读写字段。 */
        using PIN = LowLevel::Field<Reg, 20, 1, std::uint32_t>; /**< Pin，1位读写字段。 */
        using CRYPTOKEY_ALT = LowLevel::Field<Reg, 21, 1, std::uint32_t>; /**< Cryptokey Alt，1位读写字段。 */
        using CRYPTODCP_ALT = LowLevel::Field<Reg, 22, 1, std::uint32_t>; /**< Cryptodcp Alt，1位读写字段。 */
        using HWSW_SHADOW_ALT = LowLevel::Field<Reg, 23, 1, std::uint32_t>; /**< Hwsw Shadow Alt，1位读写字段。 */
        using ROM0 = LowLevel::Field<Reg, 24, 1, std::uint32_t>; /**< Rom0，1位读写字段。 */
        using ROM1 = LowLevel::Field<Reg, 25, 1, std::uint32_t>; /**< Rom1，1位读写字段。 */
        using ROM2 = LowLevel::Field<Reg, 26, 1, std::uint32_t>; /**< Rom2，1位读写字段。 */
        using ROM3 = LowLevel::Field<Reg, 27, 1, std::uint32_t>; /**< Rom3，1位读写字段。 */
        using ROM4 = LowLevel::Field<Reg, 28, 1, std::uint32_t>; /**< Rom4，1位读写字段。 */
        using ROM5 = LowLevel::Field<Reg, 29, 1, std::uint32_t>; /**< Rom5，1位读写字段。 */
        using ROM6 = LowLevel::Field<Reg, 30, 1, std::uint32_t>; /**< Rom6，1位读写字段。 */
        using ROM7 = LowLevel::Field<Reg, 31, 1, std::uint32_t>; /**< Rom7，1位读写字段。 */
    } // namespace LOCK
