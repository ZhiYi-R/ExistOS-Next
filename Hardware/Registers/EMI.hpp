...
namespace Hardware::Registers::EMI {
    ...
    namespace CTRL {
        ...
        using CE_SELECT = LowLevel::Field<Reg, 0, 4, CE_SELECT_Values>; /**< Ce Select，4位读写字段。 */
        using RESET_OUT = LowLevel::Field<Reg, 4, 1, std::uint32_t>; /**< Reset Out，1位读写字段。 */
        using WRITE_PROTECT = LowLevel::Field<Reg, 5, 1, std::uint32_t>; /**< Write Protect，1位读写字段。 */
        using MEM_WIDTH = LowLevel::Field<Reg, 6, 1, std::uint32_t>; /**< Mem Width，1位读写字段。 */
        using HIGH_PRIORITY_WRITE = LowLevel::Field<Reg, 8, 3, std::uint32_t>; /**< High Priority Write，3位读写字段。 */
        using PRIORITY_WRITE_ITER = LowLevel::Field<Reg, 12, 3, std::uint32_t>; /**< Priority Write Iter，3位读写字段。 */
        ...
        using PORT_PRIORITY_ORDER = LowLevel::Field<Reg, 16, 5, PORT_PRIORITY_ORDER_Values>; /**< Port Priority Order，5位读写字段。 */
        /** @brief ARB_MODE 的取值。 */
        ...
        using ARB_MODE = LowLevel::Field<Reg, 22, 2, ARB_MODE_Values>; /**< Arb Mode，2位读写字段。 */
        using DLL_RESET = LowLevel::Field<Reg, 24, 1, std::uint32_t>; /**< Dll Reset，1位读写字段。 */
        using DLL_SHIFT_RESET = LowLevel::Field<Reg, 25, 1, std::uint32_t>; /**< Dll Shift Reset，1位读写字段。 */
        /** @brief AXI_DEPTH 的取值。 */
        ...
        using AXI_DEPTH = LowLevel::Field<Reg, 26, 2, AXI_DEPTH_Values>; /**< Axi Depth，2位读写字段。 */
        using TRAP_INIT = LowLevel::Field<Reg, 28, 1, std::uint32_t>; /**< Trap Init，1位读写字段。 */
        using TRAP_SR = LowLevel::Field<Reg, 29, 1, std::uint32_t>; /**< Trap Sr，1位读写字段。 */
    ...
    namespace STAT {
        ...
        using NOR_BUSY = LowLevel::Field<Reg, 0, 1, NOR_BUSY_Values>; /**< Nor Busy，1位读写字段。 */
        /** @brief DRAM_HALTED 的取值。 */
        enum class DRAM_HALTED_Values : std::uint32_t {
            NOT_HALTED = 0x0,
            HALTED = 0x1,
        };
        using DRAM_HALTED = LowLevel::Field<Reg, 1, 1, DRAM_HALTED_Values>; /**< Dram Halted，1位读写字段。 */
        using LARGE_DRAM_ENABLED = LowLevel::Field<Reg, 29, 1, std::uint32_t>; /**< Large Dram Enabled，1位读写字段。 */
        using NOR_PRESENT = LowLevel::Field<Reg, 30, 1, std::uint32_t>; /**< Nor Present，1位读写字段。 */
        using DRAM_PRESENT = LowLevel::Field<Reg, 31, 1, std::uint32_t>; /**< Dram Present，1位读写字段。 */
    } // namespace STAT
    ...
    namespace TIME {
        ...
        using TAS = LowLevel::Field<Reg, 0, 4, std::uint32_t>; /**< Tas，4位读写字段。 */
        using TDS = LowLevel::Field<Reg, 8, 5, std::uint32_t>; /**< Tds，5位读写字段。 */
        using TDH = LowLevel::Field<Reg, 16, 4, std::uint32_t>; /**< Tdh，4位读写字段。 */
        using THZ = LowLevel::Field<Reg, 24, 4, std::uint32_t>; /**< Thz，4位读写字段。 */
    } // namespace TIME
    ...
    namespace DDR_TEST_MODE_CSR {
        ...
        using START = LowLevel::Field<Reg, 0, 1, std::uint32_t>; /**< Start，1位读写字段。 */
        using DONE = LowLevel::Field<Reg, 1, 1, std::uint32_t>; /**< Done，1位读写字段。 */
    } // namespace DDR_TEST_MODE_CSR
    ...
    namespace DEBUG {
        ...
        using NOR_STATE = LowLevel::Field<Reg, 0, 4, std::uint32_t>; /**< Nor State，4位读写字段。 */
    } // namespace DEBUG
    ...
    namespace DDR_TEST_MODE_STATUS0 {
        ...
        using ADDR0 = LowLevel::Field<Reg, 0, 13, std::uint32_t>; /**< Addr0，13位读写字段。 */
    } // namespace DDR_TEST_MODE_STATUS0
    ...
    namespace DDR_TEST_MODE_STATUS1 {
        ...
        using ADDR1 = LowLevel::Field<Reg, 0, 13, std::uint32_t>; /**< Addr1，13位读写字段。 */
    } // namespace DDR_TEST_MODE_STATUS1
    ...
    namespace DDR_TEST_MODE_STATUS2 {
        ...
        using DATA0 = LowLevel::Field<Reg, 0, 32, std::uint32_t>; /**< Data0，32位读写字段。 */
    } // namespace DDR_TEST_MODE_STATUS2
    ...
    namespace DDR_TEST_MODE_STATUS3 {
        ...
        using DATA1 = LowLevel::Field<Reg, 0, 32, std::uint32_t>; /**< Data1，32位读写字段。 */
    } // namespace DDR_TEST_MODE_STATUS3
